...
impl Ppu {
  ...
  fn render_bg(&mut self) {
    ...
    for i in 0..LCD_WIDTH {
      ...
      let tile_idx = self.get_tile_index_from_tile_map(self.lcdc & BG_TILE_MAP > 0, y >> 3, x >> 3);
  ...
  fn get_tile_index_from_tile_map(&self, tile_map: bool, row: u8, col: u8) -> usize {
  ...
  fn get_pixel_from_tile(&self, tile_index: usize, row: u8, col: u8) -> u8 {
